...
**Status**: Early public release (v0.11.3) - API may evolve based on feedback. See [CHANGELOG.md](CHANGELOG.md) for details.
...
```gradle
dependencies {
    implementation 'io.btrace:jafar-parser:0.11.3'
    annotationProcessor 'io.btrace:jafar-processor:0.11.3'
}
```
