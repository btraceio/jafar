...
**Status**: Early public release (v0.9.0) - API may evolve based on feedback. See [CHANGELOG.md](CHANGELOG.md) for details.
...
```gradle
dependencies {
    implementation 'io.btrace:jafar-parser:0.9.0'
    annotationProcessor 'io.btrace:jafar-processor:0.9.0'
}
```
