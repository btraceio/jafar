...
public class Main {
  ...
  private static void runWithJmc(File file, LongAccumulator sum, AtomicInteger cnt)
  ...
  private static void runWithJafar(File file, LongAccumulator sum, AtomicInteger cnt)
      throws Exception {
    ...
    //        try (TypedJafarParser p = parsingContext.newTypedParser(file.toPath())) {
    //            HandlerRegistration<JFRExecutionSample> h1 = p.handle(JFRExecutionSample.class,
    // (event, ctl) -> {
    //                if (event.sampledThread() == null) {
    //                    throw new RuntimeException();
    //                }
  ...
  private static void runWithJfr(File file, LongAccumulator sum, AtomicInteger cnt)
      throws IOException, CouldNotLoadRecordingException {
  ...
  private static void runWithJfrStream(File file, LongAccumulator sum, AtomicInteger cnt)
      throws IOException, CouldNotLoadRecordingException {
