...
public final class IndexFormat {
   ...
   *   <li><strong>elementType</strong>: BasicType constant for primitive arrays (BYTE=8, INT=10,
   *       etc.), 0 otherwise
   * </ul>
   */
   ...
   * </pre>
   *
   * <p>Sequential by classId32 for direct offset calculation. Maps 32-bit sequential class IDs back
   * to original 64-bit class addresses from the heap dump.
   */
   ...
   *
   * <p>With 4 MB pages, 256 pages = 1 GB max cache per index. Uses SoftReferences so GC can reclaim
