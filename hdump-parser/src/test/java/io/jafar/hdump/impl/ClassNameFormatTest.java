...
class ClassNameFormatTest {
  ...
  void testGetClassByName_requiresInternalFormat() {
    ...
    assertTrue(
        withSlashes.isPresent(), "Should find class with internal format (java/lang/String)");
    assertFalse(
        withDots.isPresent(), "Should NOT find class with qualified format (java.lang.String)");
  }
  ...
  void testGetObjectsOfClass_requiresInternalFormat() {
    ...
    assertTrue(
        countWithSlashes > 0, "Should find String objects with internal format (java/lang/String)");
    assertEquals(
  ...
  void testClassNameUtil_toInternal() {
    ...
    assertEquals(
        ...
        ClassNameUtil.toInternal("java.util.concurrent.ConcurrentHashMap"));
  ...
  void testClassNameUtil_toQualified() {
    ...
    assertEquals(
        "java.util.concurrent.ConcurrentHashMap",
        ClassNameUtil.toQualified("java/util/concurrent/ConcurrentHashMap"));
