...
/** Unit tests for OtelpSessionRegistry session management logic. */
@UnitTest
class OtelpSessionRegistryUnitTest {

  @TempDir Path tempDir;

  private OtelpSessionRegistry registry;

  @BeforeEach
  void setUp() {
    registry = new OtelpSessionRegistry();
  }
  ...
  void getOrCurrentThrowsWhenNoCurrentSession() {
    ...
    assertTrue(ex.getMessage().contains("otelp_open"));
  }
