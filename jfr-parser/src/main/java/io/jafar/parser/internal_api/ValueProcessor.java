 ...
 *
 * <p>This interface provides callback methods for handling different types of values encountered
 * during JFR parsing. All methods have default implementations that do nothing, allowing
 * implementors to override only the methods they need.
 */
public interface ValueProcessor {
   ...
   */
  default void onConstantPoolIndex(
