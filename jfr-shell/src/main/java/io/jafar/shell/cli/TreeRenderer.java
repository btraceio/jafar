...
public final class TreeRenderer {
    ...
    /**
     * Recursive rendering: prints the class, and for each field whose type is a non-primitive metadata class,
     * loads and prints its subtree. Cycles are prevented via a visited set.
     */
    public static void renderMetadataRecursive(Path recording, String rootType, CommandDispatcher.IO io) {
    ...
    /**
     * Render a specific field of a metadata class as the root, including its annotations and recursively
     * expanding the field's type metadata inline according to the provided depth.
     */
    public static void renderFieldRecursive(Path recording, String ownerType, String fieldName, CommandDispatcher.IO io, int maxDepth) {
