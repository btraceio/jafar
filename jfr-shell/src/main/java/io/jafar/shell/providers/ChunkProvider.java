...
public final class ChunkProvider {
    ...
    /**
     * Load all chunks as row maps.
     * Returns: index, offset, size, startNanos, duration, compressed
     *
     ...
     * @throws Exception if parsing fails
     */
    public static List<Map<String, Object>> loadChunks(Path recording, Predicate<Map<String, Object>> filter) throws Exception {
     ...
     * Returns: totalChunks, totalSize, avgSize, minSize, maxSize, compressedCount
     *
     * @param recording the JFR recording file path
