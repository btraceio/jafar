 ...
 *
 * <p>Note: This mirrors the logic used by JfrPathEvaluator for metadata queries, but centralizes it
 * for reuse by commands (e.g., 'metadata class').
 */
              ...
              if (clazz != null) {
                ...
                try {
                  ...
                  for (Map.Entry<String, Map<String, Object>> e :
                      clazz.getSettingsByName().entrySet()) {
