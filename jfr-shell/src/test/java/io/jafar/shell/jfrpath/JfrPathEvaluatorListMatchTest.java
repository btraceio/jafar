    ...
    void matchesAnyAllNoneAcrossFrames() throws Exception {
        ...
        var src = (JfrPathEvaluator.EventSource) (recording, consumer) -> {
            consumer.accept(new JfrPathEvaluator.Event("jdk.ExecutionSample", Map.of(
                    "stackTrace", Map.of(
                            "truncated", true,
                            "frames", new Object[]{ frame("Main.doWork"), frame("Helper.step") }
                    )
            )));
            consumer.accept(new JfrPathEvaluator.Event("jdk.ExecutionSample", Map.of(
                    "stackTrace", Map.of(
                            "truncated", false,
                            "frames", new Object[]{ frame("Other.run"), frame("Other.more") }
                    )
            )));
        };
        ...
        var q2 = JfrPathParser.parse("events/jdk.ExecutionSample[any:stackTrace/frames/method/name/string~'.*Main.*']");
        ...
        var q3 = JfrPathParser.parse("events/jdk.ExecutionSample[all:stackTrace/frames/method/name/string~'.*Main.*']");
        ...
        var q4 = JfrPathParser.parse("events/jdk.ExecutionSample[none:stackTrace/frames/method/name/string~'.*Main.*']");
