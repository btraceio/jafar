...
import io.jafar.otelp.shell.cli.OtelpShellCompleter;
 ...
 */
public final class OtelpModule implements ShellModule {

  private static final Logger LOG = LoggerFactory.getLogger(OtelpModule.class);
  ...
  public QueryEvaluator getQueryEvaluator() {
    return new OtelpQueryEvaluator();
  }

  @Override
  public Completer getCompleter(SessionManager<?> sessions, Object context) {
    return new OtelpShellCompleter(sessions);
  }
  ...
  public void initialize() {
    LOG.debug("otelp module initialized");
  }

  @Override
  public void shutdown() {
    LOG.debug("otelp module shutdown");
  }
}
