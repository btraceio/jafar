...
/** Completer for function parameters inside otelp pipeline operators. */
public final class OtelpFunctionParamCompleter implements ContextCompleter<OtelpMetadataService> {
  ...
  private void completeStackprofile(
      String partial, String prefix, OtelpMetadataService metadata, List<Candidate> candidates) {
