...
/** Completer for pipeline operators after {@code |} in otelp queries. */
public final class OtelpPipelineOperatorCompleter
    implements ContextCompleter<OtelpMetadataService> {
