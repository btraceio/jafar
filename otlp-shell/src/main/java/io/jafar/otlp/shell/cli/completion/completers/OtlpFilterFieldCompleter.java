...
/**
 * Completer for field names inside otlp filter predicates ({@code samples[...]}).
 *
 * <p>Suggests value type names from the active session plus structural fields such as {@code
 * stackTrace/0/name} and {@code thread}.
 */
public final class OtlpFilterFieldCompleter implements ContextCompleter<OtlpMetadataService> {
