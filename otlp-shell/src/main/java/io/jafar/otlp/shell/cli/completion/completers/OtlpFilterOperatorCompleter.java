...
/** Completer for comparison operators inside otlp filter predicates. */
public final class OtlpFilterOperatorCompleter implements ContextCompleter<OtlpMetadataService> {
