 ...
 *
 * <p>Implementations are idempotent; calling {@code destroy(...)} multiple times is safe.
 *
 * <p>The {@code cookie} must be the parser instance that created this registration. This prevents
 * accidental deregistration from a different parser.
 *
