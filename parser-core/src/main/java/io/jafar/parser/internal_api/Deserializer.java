...
public abstract class Deserializer<T> {
  ...
  /**
   * Gets a primitive deserializer for the specified type name.
   *
   * @param typeName the primitive type name (e.g. "int", "java.lang.String")
   * @return a deserializer for the primitive type, or null if not a known primitive
   */
