 ...
 *
 * <p>Uses Fibonacci hashing with linear probing and a sentinel key ({@link Long#MIN_VALUE}). {@code
 * null} values are not supported — any slot whose value is {@code null} is treated as empty.
 *
