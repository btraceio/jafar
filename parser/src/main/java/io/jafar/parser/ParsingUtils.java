 ...
 * <p>
 * This class provides static utility methods for common parsing operations
 * such as string handling and byte array processing.
 * </p>
 */
public final class ParsingUtils {
     ...
     * <p>
     * This class provides utility methods for parsing operations in JFR recordings.
     * </p>
     */
    public ParsingUtils() {}
     ...
     * <p>
     * This method handles various string encoding formats used in JFR recordings:
     * - ID 0: null string
     * - ID 1: empty string
     * - ID 2: string constant reference
     * - ID 3: UTF-8 encoded string
     * - ID 4: UTF-16 encoded string
     * - ID 5: LATIN1 encoded string
     * </p>
     * 
     ...
     * <p>
     * This method is useful when the string content is not needed and only
     * the position in the stream needs to be advanced.
     * </p>
     * 
