 ...
 * <p>
 * This class provides methods to efficiently skip over JFR data values
 * without deserializing them, which is useful for selective parsing
 * or when only certain event types are of interest.
 * </p>
 */
public final class ValueLoader {
     ...
     * <p>
     * This class provides utility methods for skipping over JFR values during parsing.
     * </p>
     */
    public ValueLoader() {}
     ...
     * <p>
     * This method efficiently skips over JFR data values based on their type
     * descriptor. For arrays, it reads the length and skips each element.
     * For constant pool values, it skips the constant pool references.
     * For regular values, it delegates to the type descriptor's skip method.
     * </p>
     * 
