 ...
 *
 * <p>Invoked synchronously on the parser thread; keep work minimal or offload.
 *
...
public interface JFRHandler<T> {
   ...
   *
   * <p>This class wraps a JFRHandler with its corresponding Class object to enable safe casting of
   * events to the expected type.
   *
   ...
   * @param ctl parser control utilities; {@link Control#stream()} exposes the current byte position
