...
public class JafarSerializationException extends JafarParseException {
   ...
   */
  public static JafarSerializationException bytecodeGenerationFailed(
      String className, Throwable cause) {
    return new JafarSerializationException(
        "Failed to generate bytecode for class", cause, className);
  }
   ...
   */
  public static JafarSerializationException bytecodeGenerationFailed(
      String className, Path debugPath, Throwable cause) {
    return new JafarSerializationException(
        String.format(
            "Failed to generate bytecode for class. Debug bytecode available at: %s", debugPath),
        cause,
        className);
  }
  ...
  public static JafarSerializationException classLoadingFailed(String className, Throwable cause) {
    return new JafarSerializationException(
        "Failed to load generated handler class", cause, className);
  }
   ...
   * @return a new JafarSerializationException instance
   */
  public static JafarSerializationException methodHandleCreationFailed(
