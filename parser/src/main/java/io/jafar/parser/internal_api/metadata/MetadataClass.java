...
public final class MetadataClass extends AbstractMetadataElement {
    ...
    public void bindDeserializer() {
        DESERIALIZER_UPDATER.updateAndGet(this, v -> (v == null) ? getContext().get(DeserializerCache.class).computeIfAbsent(new LazyParserContext.DeserializerKey(MetadataClass.this), k -> Deserializer.forType(MetadataClass.this)) : v);
    }
