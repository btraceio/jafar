 ...
 *
 * <p>This class provides methods for efficiently packing multiple byte values into a single
 * integer, with support for different byte orders.
 */
public class BytePacking {
  /**
   * Public constructor for BytePacking.
   *
   * <p>This class provides utility methods for packing bytes and does not maintain state.
   */
  public BytePacking() {}
   ...
   *
   * <p>The method packs four 8-bit ASCII characters into a 32-bit integer, with support for both
