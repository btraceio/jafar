...
public class BuildTimeHandlerBenchmark {
   ...
   *
   * <p>Handlers are generated by jafar-processor during compilation and auto-discovered via
   * ServiceLoader. The parser automatically registers factories from META-INF/services. Benefits:
   *
   * <ul>
   ...
   *   <li>Auto-discovery via ServiceLoader - no manual registration needed
   * </ul>
   */
  @Benchmark
  public void parseWithBuildTimeGeneration(Blackhole bh) throws Exception {
    ...
    try (TypedJafarParser parser = ctx.newTypedParser(testFile)) {
      // Build-time generated factories are auto-discovered via ServiceLoader.
      // The annotation processor generates META-INF/services/io.jafar.parser.api.HandlerFactory
      // which is loaded automatically by TypedJafarParserImpl constructor.
   ...
   * generation. Factories are auto-discovered via ServiceLoader.
   */
  @Benchmark
   ...
   * overhead. Factories are auto-discovered via ServiceLoader.
   */
  @Benchmark
  @Fork(1)
  @Warmup(iterations = 0)
