...
/** Completer for function parameters inside pprof pipeline operators. */
public final class PprofFunctionParamCompleter implements ContextCompleter<PprofMetadataService> {
  ...
  private void completeStackprofile(
      String partial, String prefix, PprofMetadataService metadata, List<Candidate> candidates) {
