...
/** Completer for pipeline operators after {@code |} in pprof queries. */
public final class PprofPipelineOperatorCompleter
    implements ContextCompleter<PprofMetadataService> {
