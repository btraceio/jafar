...
public record CompletionContext(
    ...
    /** The command being completed (show, metadata, open, etc.) - null if not determined */
    String command,

    /** Root path type (events, objects, classes, etc.) - null if not in path context */
    String rootType,

    /** Type/event name extracted from path - null if not determined */
    String typePattern,
    ...
    /** Additional context-specific data (module-specific extensions) */
